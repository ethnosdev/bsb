...
void main() {
  ...
  testWidgets(
    'AboutPage displays top elements in correct order and buttons work',
    (tester) async {
      ...
      // 2. BSB text
      expect(
        find.text('BSB text: 3rd printing (7-31-2026)'),
        findsOneWidget,
      );
      ...
      // 4. 'What is the BSB?' button
      final whatIsBsbButtonFinder = find.widgetWithText(
        OutlinedButton,
        'What is the BSB?',
      );
      ...
      final copyEmailButtonFinder = find.widgetWithText(
        OutlinedButton,
        'Copy contact email',
      );
      ...
      expect(
        find.text('Copied contact@ethnos.dev to clipboard'),
        findsOneWidget,
      );
    },
  );
